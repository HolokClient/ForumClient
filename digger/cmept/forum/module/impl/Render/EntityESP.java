...
public class EntityESP
    ...
    public void onRender2D(EventRender2D event) {
        ...
        for (Entity entity : Helper.mc.world.loadedEntityList) {
            ...
            if (forum.instance.friendManager.isFriend(entity.getName()) && friendHighlight.getCurrentValue()) {
            ...
            double height = (double) entity.height + (entity.isSneaking() || entity == EntityESP.mc.player && EntityESP.mc.player.isSneaking() ? -0.3 : !(!forum.instance.featureManager.getFeature(CustomModel.class).isEnabled() || CustomModel.onlyMe.getCurrentValue() && entity != EntityESP.mc.player || !CustomModel.modelMode.currentMode.equals("Crab") && !CustomModel.modelMode.currentMode.equals("Amogus") && !CustomModel.modelMode.currentMode.equals("Chinchilla") && !CustomModel.modelMode.currentMode.equals("Red Panda")) ? -0.5 : 0.2);
