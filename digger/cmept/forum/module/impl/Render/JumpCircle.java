...
import digger.cmept.forum.utils.otherutils.gayutil.MathUtil;
...
public class JumpCircle extends Module {
    ...
    public static ColorSetting jumpCircleColor = new ColorSetting("JumpCircle Color", RenderUtils.injectAlpha(ClientHelper.getClientColor(1, 15, 5), 220).getRGB(), () ->true);
    static float pt;
    ...
    public void onJump(EventUpdate event) {
        if (Helper.mc.player.motionY == 0.33319999363422365)
            handleEntityJump(Helper.mc.player);
        onLocalPlayerUpdate(Helper.mc.player);
    }
    @EventTarget
