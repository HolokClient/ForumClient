package digger.cmept.forum.ui.altmanager;
...
import digger.cmept.forum.ui.altmanager.alt.AltLoginThread;
import digger.cmept.forum.ui.altmanager.api.AltService;
...
public class GuiAltManager extends GuiScreen {
    ...
    public void drawScreen(int par1, int par2, float par3) {
        ...
        mc.neverlose900_30.drawCenteredStringWithShadow("MINCED", (float) (sr.getScaledWidth() / 2), (float) (sr.getScaledHeight() / 2.2), new Color(255, 255, 255, 30).getRGB());
        ...
        String altName = "Name: " + (forum.instance.featureManager.getFeature(NameProtect.class).isEnabled() && NameProtect.myName.getCurrentValue() ? "Protected" : mc.session.getUsername());
        ...
        while (true) {
            ...
            GlStateManager.popMatrix();
            mc.rubik_16.drawString((forum.instance.featureManager.getFeature(NameProtect.class).isEnabled() && NameProtect.myName.getCurrentValue() ? "Protected" : name), (float) width / 2.0f - 80, (float) ((double) y - offset + 5.0), -1);
