...
import digger.cmept.forum.ui.celestun4ik.panelcomponent;
import digger.cmept.forum.ui.components.SorterHelper;
...
public final class ModuleComponent extends ExpandableComponent {
    ...
    public ModuleComponent(digger.cmept.forum.ui.celestun4ik.component.Component parent, Module module, int x, int y, int width, int height) {
    ...
    public void drawComponent(ScaledResolution scaledResolution, int mouseX, int mouseY) {
        ...
        if (isExpanded()) {
            ...
            for (digger.cmept.forum.ui.celestun4ik.component.Component child : components) {
