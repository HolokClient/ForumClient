...
public class MultipleBoolSettingComponent extends ExpandableComponent implements PropertyComponent {
	...
	public void drawComponent(ScaledResolution scaledResolution, int mouseX, int mouseY) {
		...
		mc.mntsb_13.drawString(getName() + ":", x - 2, dropDownBoxY - 1, forum.instance.featureManager.getFeature(parent.getName()).isEnabled() ? Color.WHITE.getRGB() : Color.BLACK.getRGB());
		if (isExpanded()) {
			if (ClickGUI.shadow.getCurrentValue()) {
