...
import digger.cmept.forum.ui.celestun4ik.component.AnimationState;
import digger.cmept.forum.ui.celestun4ik.component.Component;
import digger.cmept.forum.ui.celestun4ik.component.DraggablePanel;
...
public final class panelcomponent extends DraggablePanel {
    ...
    public panelcomponent(ModuleCategory category, int x, int y) {
        ...
        this.features = forum.instance.featureManager.getFeaturesCategory(category);
