                ...
                if (arguments.length > 1) {
                    if (arguments[0].equals("macro")) {
                        if (arguments[1].equals("add")) {
                            ...
                            forum.instance.macroManager.addMacro(new Macro(Keyboard.getKeyIndex(arguments[2].toUpperCase()), command.toString()));
                            forum.instance.fileManager.getFile(MacroConfig.class).saveFile();
                        ...
                        if (arguments[1].equals("clear")) {
                            if (forum.instance.macroManager.getMacros().isEmpty()) {
                                ChatUtils.addChatMessage((Object)((Object)ChatFormatting.RED) + "Your macros list is empty!");
                                return;
                            }
                            forum.instance.macroManager.getMacros().clear();
                        ...
                        if (arguments[1].equals("remove")) {
                            forum.instance.macroManager.deleteMacroByKey(Keyboard.getKeyIndex(arguments[2].toUpperCase()));
                        ...
                        if (arguments[1].equals("list")) {
                            ...
                            forum.instance.macroManager.getMacros().forEach(macro -> ChatUtils.addChatMessage((Object)((Object)ChatFormatting.GREEN) + "Macros list: " + (Object)((Object)ChatFormatting.WHITE) + "Macros Name: " + (Object)((Object)ChatFormatting.RED) + macro.getValue() + (Object)((Object)ChatFormatting.WHITE) + ", Macro Bind: " + (Object)((Object)ChatFormatting.RED) + Keyboard.getKeyName(macro.getKey())));
                        }
                    }
                } else {
