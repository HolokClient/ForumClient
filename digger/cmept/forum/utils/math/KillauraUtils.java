package digger.cmept.forum.utils.math;

import digger.cmept.forum.forum;
import digger.cmept.forum.utils.Helper;
import digger.cmept.forum.module.impl.Combat.AntiBot;
import digger.cmept.forum.module.impl.Combat.AutoTotem;
...
public class KillauraUtils implements Helper {
    ...
    public static boolean canAttack(EntityLivingBase player) {
        ...
        if ((forum.instance.featureManager.getFeature(AntiBot.class).isEnabled() && AntiBot.isBotPlayer.contains(player))) {
            return false;
        }
    ...
    public static boolean isBot(EntityLivingBase entity) {
        if (entity instanceof EntityPlayer) {
            ...
            return forum.instance.featureManager.getFeature(AntiBot.class).isEnabled() && AntiBot.isBotPlayer.contains(player);
        }
        return false;
    }
