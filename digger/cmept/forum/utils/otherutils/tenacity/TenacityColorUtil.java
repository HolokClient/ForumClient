package digger.cmept.forum.utils.otherutils.tenacity;
...
public class TenacityColorUtil {
    ...
    public static Color interpolateColorC(Color color1, Color color2, float amount) {
        amount = Math.min(1, Math.max(0, amount));
        return new Color(TenacityMathUtil.interpolateInt(color1.getRed(), color2.getRed(), amount),
                TenacityMathUtil.interpolateInt(color1.getGreen(), color2.getGreen(), amount),
                TenacityMathUtil.interpolateInt(color1.getBlue(), color2.getBlue(), amount),
                TenacityMathUtil.interpolateInt(color1.getAlpha(), color2.getAlpha(), amount));
    }
    ...
    public static Color interpolateColorHue(Color color1, Color color2, float amount) {
        ...
        Color resultColor = Color.getHSBColor(TenacityMathUtil.interpolateFloat(color1HSB[0], color2HSB[0], amount),
                TenacityMathUtil.interpolateFloat(color1HSB[1], color2HSB[1], amount), TenacityMathUtil.interpolateFloat(color1HSB[2], color2HSB[2], amount));
