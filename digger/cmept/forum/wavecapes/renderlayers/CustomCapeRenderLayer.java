package digger.cmept.forum.wavecapes.renderlayers;

import digger.cmept.forum.wavecapes.stim.StickSimulation;
import digger.cmept.forum.wavecapes.util.Mth;
...
public class CustomCapeRenderLayer implements LayerRenderer<AbstractClientPlayer> {
    ...
    public void doRenderLayer(AbstractClientPlayer abstractClientPlayer, float paramFloat1, float paramFloat2, float deltaTick,
        ...
        if (forum.instance.featureManager.getFeature((CustomModel.class)).getState()) {
            return;
        }
